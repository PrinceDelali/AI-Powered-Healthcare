      ...
      {loading ? (
        ...
        <>
          ...
          <div className="hidden lg:flex lg:w-1/2 bg-emerald-600 text-white flex-col justify-center items-center p-12 relative overflow-hidden shadow-xl rounded-r-xl">
            ...
            >
              Log in to access your personalized dashboard and continue your health journey.
            </motion.p>
            ...
            <div className="w-full max-w-md bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <Link to="/forgotpassword" className="text-sm text-emerald-600 hover:underline">
                    Forgot password?
                  </Link>
                </div>
